...
export const RELEASES: Release[] = [
  ...
  },
  {
    ...
    changes: [
      { kind: 'added', text: 'Lamplight. Every lamp shines one way, and its beam runs until it meets a wall, another lamp, or the edge. Turn them so every dark square ends up lit and none is lit twice. Drag out of a lamp to aim it — the beam swings with your finger — or tap to turn it round the compass.' },
      ...
      { kind: 'changed', text: 'No lamp comes pre-aimed. An early version handed out a few locked lamps because the generator could otherwise make only two boards in two hundred with a single answer; fixing how boards are laid out solved that as a side effect, and the locked lamps had stayed on long after the reason for them was gone.' }
    ]
  },
  {
    version: '2.8.0',
