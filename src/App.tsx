...
import LamplightGame from './games/lamplight/LamplightGame.tsx';
...
export default function App() {
  ...
  return (
    <>
      ...
      {meta?.id === 'lamplight' && <LamplightGame key="lamplight" shared={shared} seed={route.seed} onBack={() => go(indexHref)} />}
      {!meta && (
        <div className="wrap">
